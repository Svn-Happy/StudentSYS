...
public class JavaEmail {
	//发件人的邮箱和授权码
	private final String myEmailAccount = "734394415@qq.com";//发送的邮箱
	private final String myEmailPassword = "hcggouyqbibqbcih";
	...
	public  MimeMessage createMessage(Session session, String sendMail, String receiveMail,String info) throws Exception {
		...
		message.setSubject("学生验证码测试", "UTF-8");
		// 5. Content: 邮件正文（可以使用html标签）（内容有广告嫌疑，避免被邮件服务器误认为是滥发广告以至返回失败，请修改发送内容）
		message.setContent("您的学生管理系统【验证码】:"+info+"请勿泄露他人，违者是我儿子", "text/html;charset=UTF-8");
		// 6. 设置发件时间
